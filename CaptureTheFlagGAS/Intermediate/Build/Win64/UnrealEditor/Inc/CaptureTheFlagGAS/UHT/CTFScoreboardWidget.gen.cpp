...
// ********** Begin Class UCTFScoreboardWidget Function HandleFlagCaptured *************************
struct Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics
{
	struct CTFScoreboardWidget_eventHandleFlagCaptured_Parms
	{
		ETeam CapturingTeam;
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_CapturingTeam_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_CapturingTeam = { "CapturingTeam", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFScoreboardWidget_eventHandleFlagCaptured_Parms, CapturingTeam), Z_Construct_UEnum_CaptureTheFlagGAS_ETeam, METADATA_PARAMS(0, nullptr) }; // 576107608
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_CapturingPlayer = { "CapturingPlayer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFScoreboardWidget_eventHandleFlagCaptured_Parms, CapturingPlayer), Z_Construct_UClass_ACTFPlayerState_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_NewScore = { "NewScore", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFScoreboardWidget_eventHandleFlagCaptured_Parms, NewScore), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_CapturingTeam_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_CapturingTeam,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_CapturingPlayer,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::NewProp_NewScore,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCTFScoreboardWidget, nullptr, "HandleFlagCaptured", Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::CTFScoreboardWidget_eventHandleFlagCaptured_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::CTFScoreboardWidget_eventHandleFlagCaptured_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCTFScoreboardWidget::execHandleFlagCaptured)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->HandleFlagCaptured(ETeam(Z_Param_CapturingTeam),Z_Param_CapturingPlayer,Z_Param_NewScore);
	P_NATIVE_END;
}
// ********** End Class UCTFScoreboardWidget Function HandleFlagCaptured ***************************

// ********** Begin Class UCTFScoreboardWidget Function HandleScoreChanged *************************
struct Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics
{
	struct CTFScoreboardWidget_eventHandleScoreChanged_Parms
	{
		ETeam Team;
		int32 NewScore;
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/UI/CTFScoreboardWidget.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Event handlers for real-time updates" },
#endif
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::NewProp_Team_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::NewProp_Team = { "Team", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFScoreboardWidget_eventHandleScoreChanged_Parms, Team), Z_Construct_UEnum_CaptureTheFlagGAS_ETeam, METADATA_PARAMS(0, nullptr) }; // 576107608
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::NewProp_NewScore = { "NewScore", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFScoreboardWidget_eventHandleScoreChanged_Parms, NewScore), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::NewProp_Team_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::NewProp_Team,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::NewProp_NewScore,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCTFScoreboardWidget, nullptr, "HandleScoreChanged", Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::CTFScoreboardWidget_eventHandleScoreChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::CTFScoreboardWidget_eventHandleScoreChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCTFScoreboardWidget::execHandleScoreChanged)
{
	P_GET_ENUM(ETeam,Z_Param_Team);
	P_GET_PROPERTY(FIntProperty,Z_Param_NewScore);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->HandleScoreChanged(ETeam(Z_Param_Team),Z_Param_NewScore);
	P_NATIVE_END;
}
// ********** End Class UCTFScoreboardWidget Function HandleScoreChanged ***************************
...
void UCTFScoreboardWidget::StaticRegisterNativesUCTFScoreboardWidget()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "HandleFlagCaptured", &UCTFScoreboardWidget::execHandleFlagCaptured },
		{ "HandleScoreChanged", &UCTFScoreboardWidget::execHandleScoreChanged },
...
struct Z_Construct_UClass_UCTFScoreboardWidget_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCTFScoreboardWidget_HandleFlagCaptured, "HandleFlagCaptured" }, // 1234107412
		{ &Z_Construct_UFunction_UCTFScoreboardWidget_HandleScoreChanged, "HandleScoreChanged" }, // 2111839189
...
struct Z_CompiledInDeferFile_FID_Personal_CaptureTheFlagGAS_CaptureTheFlagGAS_CaptureTheFlagGAS_Source_CaptureTheFlagGAS_Public_UI_CTFScoreboardWidget_h__Script_CaptureTheFlagGAS_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCTFScoreboardWidget, UCTFScoreboardWidget::StaticClass, TEXT("UCTFScoreboardWidget"), &Z_Registration_Info_UClass_UCTFScoreboardWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCTFScoreboardWidget), 185662341U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Personal_CaptureTheFlagGAS_CaptureTheFlagGAS_CaptureTheFlagGAS_Source_CaptureTheFlagGAS_Public_UI_CTFScoreboardWidget_h__Script_CaptureTheFlagGAS_54362910(TEXT("/Script/CaptureTheFlagGAS"),
