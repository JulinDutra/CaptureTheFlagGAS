...
// ********** Begin Class ACTFCaptureZone Function ValidateCaptureConditions ***********************
struct Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics
{
	struct CTFCaptureZone_eventValidateCaptureConditions_Parms
	{
		ACTFPlayerState* Player;
		FString OutReason;
		bool ReturnValue;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_Player = { "Player", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFCaptureZone_eventValidateCaptureConditions_Parms, Player), Z_Construct_UClass_ACTFPlayerState_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_OutReason = { "OutReason", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CTFCaptureZone_eventValidateCaptureConditions_Parms, OutReason), METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((CTFCaptureZone_eventValidateCaptureConditions_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(CTFCaptureZone_eventValidateCaptureConditions_Parms), &Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_Player,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_OutReason,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_ACTFCaptureZone, nullptr, "ValidateCaptureConditions", Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::PropPointers), sizeof(Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::CTFCaptureZone_eventValidateCaptureConditions_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::CTFCaptureZone_eventValidateCaptureConditions_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ACTFCaptureZone::execValidateCaptureConditions)
{
	P_GET_OBJECT(ACTFPlayerState,Z_Param_Player);
	P_GET_PROPERTY_REF(FStrProperty,Z_Param_Out_OutReason);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->ValidateCaptureConditions(Z_Param_Player,Z_Param_Out_OutReason);
	P_NATIVE_END;
}
// ********** End Class ACTFCaptureZone Function ValidateCaptureConditions *************************
...
void ACTFCaptureZone::StaticRegisterNativesACTFCaptureZone()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "ValidateCaptureConditions", &ACTFCaptureZone::execValidateCaptureConditions },
	};
...
struct Z_Construct_UClass_ACTFCaptureZone_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ACTFCaptureZone_ValidateCaptureConditions, "ValidateCaptureConditions" }, // 4166008035
	};
...
struct Z_CompiledInDeferFile_FID_Personal_CaptureTheFlagGAS_CaptureTheFlagGAS_CaptureTheFlagGAS_Source_CaptureTheFlagGAS_Public_Gameplay_CTFCaptureZone_h__Script_CaptureTheFlagGAS_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACTFCaptureZone, ACTFCaptureZone::StaticClass, TEXT("ACTFCaptureZone"), &Z_Registration_Info_UClass_ACTFCaptureZone, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACTFCaptureZone), 4156313259U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Personal_CaptureTheFlagGAS_CaptureTheFlagGAS_CaptureTheFlagGAS_Source_CaptureTheFlagGAS_Public_Gameplay_CTFCaptureZone_h__Script_CaptureTheFlagGAS_2540326735(TEXT("/Script/CaptureTheFlagGAS"),
